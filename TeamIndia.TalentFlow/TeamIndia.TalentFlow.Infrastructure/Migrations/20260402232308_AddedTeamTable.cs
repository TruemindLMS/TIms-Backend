    ...
    public partial class AddedTeamTable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TeamTaskId = table.Column<Guid>(type: "uuid", nullable: false),
                    TeamId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeamTasks", x => x.TeamTaskId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TeamUpdateId = table.Column<Guid>(type: "uuid", nullable: false),
                    TeamId = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeamUpdates", x => x.TeamUpdateId);
                    table.ForeignKey(
                        name: "FK_TeamUpdates_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TeamUpdates_Teams_TeamId",
                        column: x => x.TeamId,
                        principalTable: "Teams",
                        principalColumn: "TeamId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeamTasks_AssignedToUserId",
                table: "TeamTasks",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeamUpdates_TeamId",
                table: "TeamUpdates",
                column: "TeamId");

            migrationBuilder.CreateIndex(
                name: "IX_TeamUpdates_UserId",
                table: "TeamUpdates",
                column: "UserId");
